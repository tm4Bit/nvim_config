local M = {
	...
	keys = {
		...
		{ '<leader>sp', '<cmd>lua require("spectre").open_visual({select_word=true})<CR>',      desc = "Spectre word project wide" },
		{ '<leader>sw', '<cmd>lua require("spectre").open_file_search({select_word=true})<CR>', desc = "Spectre word on current file" },
	}
}
...
M.config = function()
	require('spectre').setup({
		...
		highlight          = {
			ui = "String",
			search = "DiagnosticSignOk",
			replace = "DiagnosticSignError"
		},
		mapping            = {
			['tab'] = {
				map = '<Tab>',
